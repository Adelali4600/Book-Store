...
export default function HomePage() {
   ...
   return (
      <>
                           ...
                           <div className="flex justify-between">
                              <div className="flex flex-col gap-2">
                                 ...
                                 <div className="flex gap-2">
                                    {/* ======================= Stars ======================= */}
                                    <div className="flex">
                                       <GrStar size={16} className="text-[#EBC305]" /> <GrStar size={16} className="text-[#EBC305]" />
                                       <GrStar size={16} className="text-[#EBC305]" /> <GrStar size={16} className="text-[#EBC305]" />
         ...
         <section className="px-[60px] py-[120px] border-t border-[#22222233] gap-14">
            <div className="flex gap-4 justify-between">
               <div className="flex flex-col gap-4">
                  <h1 className="text-[26px] font-bold text-[#222222]">Flash Sale</h1>
                  <p className="text-[16px] font-normal text-[#22222280] max-w-[516px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris et ultricies est. Aliquam in justo varius, sagittis neque ut, malesuada leo.</p>
               </div>
               <div className="flex justify-center items-center rounded-full border-[3.92px] h-36 w-36 bg-[#FFFFFF] border-mainColor">
                  <span className="font-bold text-[26px] font-Cairo">30:00:00</span>
               </div>
            </div>
